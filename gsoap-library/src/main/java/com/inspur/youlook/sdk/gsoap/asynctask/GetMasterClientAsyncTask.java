 ...
 */
public class GetMasterClientAsyncTask extends GsoapAsyncTask {

    private static final String TAG = GetMasterClientAsyncTask.class.getSimpleName();

    public GetMasterClientAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_GetMasterClient(clientInfo);
    }
}
