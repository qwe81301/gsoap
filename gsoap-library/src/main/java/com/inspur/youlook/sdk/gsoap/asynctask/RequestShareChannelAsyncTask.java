 ...
 */
public class RequestShareChannelAsyncTask extends GsoapAsyncTask {

    private static final String TAG = RequestShareChannelAsyncTask.class.getSimpleName();

    public RequestShareChannelAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_RequestShareChannel(clientInfo, requestInfo);
    }
}
