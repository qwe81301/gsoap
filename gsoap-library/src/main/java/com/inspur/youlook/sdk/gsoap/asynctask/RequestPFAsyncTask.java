 ...
 */
public class RequestPFAsyncTask extends GsoapAsyncTask {

    private static final String TAG = RequestPFAsyncTask.class.getSimpleName();

    public RequestPFAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_RequestPF(clientInfo, requestInfo);
    }
}
