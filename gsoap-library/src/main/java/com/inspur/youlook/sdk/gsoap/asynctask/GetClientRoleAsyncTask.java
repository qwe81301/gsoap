 ...
 */
public class GetClientRoleAsyncTask extends GsoapAsyncTask {

    private static final String TAG = GetClientRoleAsyncTask.class.getSimpleName();

    public GetClientRoleAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_GetClientRole(clientInfo);
    }
}
