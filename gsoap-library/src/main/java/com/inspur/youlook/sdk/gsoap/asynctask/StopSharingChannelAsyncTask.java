 ...
 */
public class StopSharingChannelAsyncTask extends GsoapAsyncTask {

    private static final String TAG = StopSharingChannelAsyncTask.class.getSimpleName();

    public StopSharingChannelAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_StopSharingChannel(clientInfo, requestInfo);
    }
}
