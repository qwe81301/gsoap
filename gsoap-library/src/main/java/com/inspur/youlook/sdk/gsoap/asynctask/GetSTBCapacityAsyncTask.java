 ...
 */
public class GetSTBCapacityAsyncTask extends GsoapAsyncTask {

    private static final String TAG = GetSTBCapacityAsyncTask.class.getSimpleName();

    public GetSTBCapacityAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_GetSTBCapacity(clientInfo);
    }
}
