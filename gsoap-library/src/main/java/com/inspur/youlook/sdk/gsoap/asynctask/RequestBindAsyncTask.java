 ...
 */
public class RequestBindAsyncTask extends GsoapAsyncTask {

    private static final String TAG = RequestBindAsyncTask.class.getSimpleName();

    public RequestBindAsyncTask(GsoapCallback callback) {
        super(callback);
    }
    ...
    JniResponse requestAPI(String... params) {
        ...
        return GsoapProxySingleton.getInstance().hpstb_RequestBind(clientInfo);
    }
}
